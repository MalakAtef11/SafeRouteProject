...
import ForgotPassword from "./Login-Register/ForgotPassword.jsx";
import ResetPassword from "./Login-Register/ResetPassword.jsx";
import VerifyEmail from "./Login-Register/VerifyEmail.jsx";
...
function App() {
  ...
  if (path === "/admin-dashboard") {
    return userType === "Admin" ? <AdminDashboard /> : <Login />;
  }

  if (path === "/chat") {
    return userId ? <Chat /> : <Login />;
  }
