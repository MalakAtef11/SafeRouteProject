...
const translations = {
  ar: {
    ...
    navSector: [{ href: "/sector-dashboard", label: "لوحة التحكم" }, { href: "/analytics", label: "الإحصائيات" }],
    navUser: [{ href: "/reports", label: "البلاغات" }, { href: "/report", label: "أبلغ الآن" }, { href: "/my-reports", label: "بلاغاتي" }, { href: "/profile", label: "ملفي" }],
  ...
  en: {
    ...
    logout: "Logout",
    logoutMenu: "Log Out",
    navSector: [{ href: "/sector-dashboard", label: "Dashboard" }, { href: "/analytics", label: "Analytics" }],
    navUser: [{ href: "/reports", label: "Reports" }, { href: "/report", label: "Report Now" }, { href: "/my-reports", label: "My Reports" }, { href: "/profile", label: "Profile" }],
